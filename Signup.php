                            ...
                            <td>
                                <fieldset>
                                    ...
                                    <table cellpadding="5" cellspacing="5">
                                        ...
                                        $result = mysqli_query($selected,"select * from signup order by (sid)desc limit 1");
                                        ...
                                        <tr>
                                            ...
                                            <td class="text">
                                              ...
                                              <td class="text"><span style="color: red;"></span>&nbsp;Branch&nbsp;Name:</td>
                                            <td class="text">
                                                <select  id="maintainclass"name="maintainclass" style="width: 180px">
                                                    <option value="Select"> - - - - - - - - - Select- - - - - - - - - </option>
                                        ...
                                        <tr>      <td class="text"><span style="color: red;">*</span> Semester&nbsp;:</td>
                                            <td class="text">
                                            ...
                                            <td class="text-1">  <select name="category" id="category"  style="width: 180px">
                                                    ...
                                                    $sql = "SELECT * FROM `teacher` ORDER BY `uname`";
                                                    $res = mysqli_query($selected,$sql);
