            ...
            <div class="content">
                <div class="content_resize">
                    <div class="mainbar">
                       ...
                       <form id="cntfrm" action="NewMarks1.php" method="post" enctype="multipart/form-data" onsubmit="validate();">
                        <table cellpadding="1" cellspacing="1" border="0">
                            <tr>
                                <td class="heading" colspan="2">Marks Details</td>
                            </tr>
                            ...
                            <tr>
                                <td>Student Name:</td>
                                <td><input type="text" id="txtsname" name="txtsname" style="width: 550px;" class="login"></td>
                            </tr>
                            <tr>
                                <td>Student Enroll:</td>
                                <td><input type="text" id="txtenroll" name="txtenroll" style="width: 550px;" class="login" onkeyup="contact(this)"></td>
                            </tr>
                            <tr>
                                <td class="text"><span style="color: red;"></span>&nbsp;Course&nbsp;Name:</td>
                                <td class="text">
                                    <select  id="maintainclass"name="maintainclass" style="width: 180px">
                            ...
                            <tr>
                               ...
                               <tr>
                                <td>Sessional-1 Marks:</td>
                                <td><input type="text" id="txtsession1" name="txtsession1" size="62" class="login" onkeyup="contact(this)"></td>
                            </tr>
                              <tr>
                                <td>Sessional-2 Marks:</td>
                                <td><input type="text" id="txtsession2" name="txtsession2" size="62" class="login" onkeyup="contact(this)"></td>
                            </tr>
                              <tr>
                                <td>Sessional-3 Marks:</td>
                                <td><input type="text" id="txtsession3" name="txtsession3" size="62" class="login" onkeyup="contact(this)"  onblur="total()"></td>
                            </tr>
                            <tr>
                                <td>Obtain Total Marks:</td>
                                <td><input type="text" id="txttmarks" name="txttmarks" size="62" class="login" onkeyup="contact(this)"></td>
                            </tr>
                            <tr>
                                <td>Aggregation:</td>
                                <td><input type="text" id="txtaggre" name="txtaggre" style="width: 550px;" class="login"></td>
                            </tr>
