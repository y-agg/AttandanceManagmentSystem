...
if ($UNAME != null) {
    ...
    if (isset($_GET['uid'])) {
        $uid = $_GET['uid'];
        echo $uid;
        $query2 = "delete from signup where a1 ='$uid'";
                ...
                <div class="content_resize">
                    ...
                    <table cellspacing="3">
                        ...
                        ?>
                            ...
                            <tr bgcolor="wheat">
                                <td><a href="UserList.php?uid=<?php echo $row ['a1']; ?>" class="leftlink">Delete</a></td>
                                <td align="center"><?php echo $row ['id']; ?></td>
                                <td align="center"><?php echo $row ['a1']; ?></td>
                                
                                <td align="center"><?php echo $row ['a7']; ?></td>
                                <td align="center"><?php echo $row ['a8']; ?></td>
                                <td align="center"><?php echo $row ['a9']; ?></td>
                                <td  align="center"><?php echo $row ['a10']; ?></td>
                                <td align="center"><?php echo $row ['a11']; ?></td>
                                <td align="center"><?php echo $row ['a12']; ?></td>
                                <td  align="center"><?php echo $row ['a13']; ?></td>
                                <td align="center"><?php echo $row ['a14']; ?></td>
