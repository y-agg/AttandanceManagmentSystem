...
if (isset($_GET['oldpwd'])) { //check old password is wrong or not
    ...
    $sqlquery = "select password from signup where uname = '$user_id'";
    $result = mysqli_query($selected,$sqlquery);
    ...
    $sql = "update signup set pwd='$newpwd' where uname='$user_id' and pwd='$oldpwd'";
