...
$query = "update signup set  fname='f$name' ,lname='$lname' ,gender='$gender',dob='$dob',mob='$phone',email='$email',address='$address',city='$city',pin='$pin',state='$state',country='$country' where uname='$user_id'";
